...
La proposition de Phase 2 d'origine est abandonnée (oubliée) → Phase 3.

## Phase 3 (sur demande)

- [x] **Minuterie de veille** *(sur demande)*
  Menu **lune** dans le lecteur : durées 15/30/45/60 min ou **fin du morceau** (temps restant, valable
