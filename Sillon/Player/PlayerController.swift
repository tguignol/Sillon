...
final class PlayerController {
    ...
    /// Pastille « qualité » condensée (codec + fréquence, ex: "FLAC · 96 kHz") posée sur la pochette ;
    /// le détail complet reste dans `currentFormatDescription`, révélé au toucher.
    ...
    /// Pastille « qualité » compacte = codec + fréquence (ex: "FLAC · 96 kHz", "MP3 · 44,1 kHz").
    /// Repli sur le seul codec si la fréquence est inconnue. Le détail complet (profondeur, débit)
    /// reste dans `formatDescription`, révélé au toucher.
